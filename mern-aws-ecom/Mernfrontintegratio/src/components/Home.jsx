...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-5">
            {[
              ...
              <Link
                key={i}
                to="/products"
                className="flex flex-col items-center gap-3 p-4 bg-white rounded-xl hover:shadow-lg transition-all duration-300 group"
              >
      ...
      {/* Features */}
      <section className="py-20 lg:py-24 bg-gray-50 border-y">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <h2 className="text-3xl font-bold text-gray-900 text-center mb-14">Why Shop With Us</h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10">
            {[
              ...
              <div key={i} className="flex items-start gap-5 bg-white p-8 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 border border-gray-100">
                <div className="flex-shrink-0 w-14 h-14 bg-orange-50 rounded-xl flex items-center justify-center">{feature.icon}</div>
                <div>
