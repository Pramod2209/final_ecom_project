    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
              ...
              <div className="relative flex items-center gap-2">
                {user ? (
                  <div className="flex items-center space-x-4">
                    ...
                    <button
                      onClick={logout}
                      className="hidden md:inline-flex items-center px-4 py-2 bg-orange-500 text-white hover:bg-orange-600 font-medium rounded-lg transition-colors"
                    >
                      Logout
                    </button>
                  </div>
                ...
                {user ? (
                  <>
                    ...
                    <button
                      ...
                      className="font-medium py-3 px-4 bg-orange-500 text-white hover:bg-orange-600 rounded-md text-left transition-colors mt-3"
                    >
                      Logout
                    </button>
                  </>
      ...
      <footer className="bg-slate-900 text-white mt-auto">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 py-16 lg:py-20">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="flex gap-4">
                <a href="#" className="w-10 h-10 bg-gray-800 hover:bg-orange-500 rounded-lg flex items-center justify-center transition-all duration-300">
          ...
          {/* Bottom Bar */}
          <div className="mt-16 pt-10 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-6">
